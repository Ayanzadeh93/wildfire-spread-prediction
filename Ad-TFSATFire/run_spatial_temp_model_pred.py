...
if __name__=='__main__':
    ...
    root_dir = os.environ.get('TS_SATFIRE_ROOT', os.path.join(os.path.dirname(os.path.abspath(__file__)), 'dataset'))
    root_dir = os.path.dirname(root_dir) if root_dir.endswith('dataset') else root_dir
